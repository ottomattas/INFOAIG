...
import main.DLQueryEngine;

public class Agent {

	static DLQueryEngine engine;
	static ShortFormProvider shortFormProvider;
	...
	public static void main(String[] args) throws Exception{
        ...
        engine = new DLQueryEngine(reasoner, shortFormProvider);
	...
	private static void testPrint(String query) {
        // Test print
